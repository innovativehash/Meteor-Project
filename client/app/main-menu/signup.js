...
Template.signup.events({
  ...
  //  Meteor.call( 'sendEmail', 'gcc.programmer@gmail.com',         /* to */
  //                            'digital.image.shooter@gmail.com',  /* from */
  //                            'Hello from Meteor!',              /* subj */
  //                            'This is a test of Email.send.'    /* msg */
  //              );
    ...
    Meteor.call( 'addUser', email, password, fname, lname, opt, dept, company, company_id, true );
